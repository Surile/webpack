...
//生产环境插件
var productionPlugins = [new CleanWebpackPlugin('*', { root: config.dist })]
...
module.exports = {
  ...
  context: config.src,
  stats: { children: false, chunks: true, assets: false, modules: false },
  target: 'node',
  entry: {
    app: ['./app.js']
  },
  ...
  plugins: [
    ...
    new WxappModulePlugin('third_modules'),
    new webpack.DefinePlugin({
